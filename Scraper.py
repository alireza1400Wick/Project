...
for Page in range(1 , 20):
    ...
    # Select everything within tag name div with "products" id and returns a list
        
    for Element in Products.select("div.OfferBox"):
            
        Information(Element)     # Call Information function with Element argument
        
        Price_Function(Element)     # Call Price_Function with Element argument
